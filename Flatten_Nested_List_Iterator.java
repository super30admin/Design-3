/*
Time Complexity - O(N + L) where N is the number of lists in nested lists and 
                                 L is the number of elements in the list.
Space Complexity - O(N + D) where N is the number of lists in nested lists and 
